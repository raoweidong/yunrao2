            ...
            for (TaobaoAuthorizeUser taobaoAuthorizeUser : taobaoAuthorizeUsers) {
                ...
                if (twoo.size() == 0) {
                    ...
                    for (AdzoneRptsDay adzoneRptsDay : adzoneRptsDayss) {
                        ...
                        advertiserAccountRptsTotalGet.setEffect(request.getEffect());
                        advertiserAccountRptsTotalGet.setEffectType(request.getEffectType());
                        advertiserAccountRptsTotalGet.setCampaignModel(request.getCampaignModel());
